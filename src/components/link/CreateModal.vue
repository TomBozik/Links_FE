        ...
        <div class="flex flex-col overflow-hidden bg-white border rounded shadow-lg">
          ...
          <form v-on:submit.prevent="createLink">
            ...
            <div class="flex items-center justify-end p-2">
              ...
              <button class="px-2 py-1 mb-1 mr-1 text-sm font-bold text-green-500 uppercase outline-none sm:px-8 hover:text-green-700 focus:outline-none" type="submit" v-on:click="createLink()">Create</button>
            </div>
          </form>
