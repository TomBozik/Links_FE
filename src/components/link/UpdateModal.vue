      ...
      <div class="relative z-50 max-w-full p-3 mx-auto my-0" style="width: 600px;">
        <div class="flex flex-col overflow-hidden bg-white border rounded shadow-lg">
          ...
          <div class="flex items-center justify-end p-2">
            ...
            <button class="px-2 py-1 mb-1 mr-1 text-sm font-bold text-blue-500 uppercase outline-none sm:px-8 hover:text-blue-700 focus:outline-none" type="button" v-on:click="updateLink()">Update</button>
          </div>
